...
gpio!(GPIOA, gpioa, parst, paen, drvr, dircr, pur, pdr, iner, odr, [
    ...
    // SWO
    PA11: (pa11, 11, Output<PushPull>, AF0, dir11, pu11, pd11, inen11, od11),
    // SWCLK
...
gpio!(GPIOE, gpioe, perst, peen, drvr, dircr, pur, pdr, iner, odr, [
    ...
    PE11: (pe11, 11, Input<Disabled>, AF0, dir11, pu11, pd11, inen11, od11),
    PE12: (pe12, 12, Input<Disabled>, AF0, dir12, pu12, pd12, inen12, od12),
    PE13: (pe13, 13, Input<Disabled>, AF0, dir13, pu13, pd13, inen13, od13),
    PE14: (pe14, 14, Input<Disabled>, AF0, dir14, pu14, pd14, inen14, od14),
    PE15: (pe15, 15, Input<Disabled>, AF0, dir15, pu15, pd15, inen15, od15),
]);
